...
Then, add the mu-repo directory to your PATH 
(after that, doing 'mu' in the command line should give a proper message).
...
Then go to the root directory containing the repositories (in this case cd /workspace),
add the repositories you want to work with and issue commands to all registered repos.
